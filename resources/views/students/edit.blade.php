...
<x-layout>
  <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Edit Student info</h1>
...
<form action="/students/{{$student->id}}" method="POST">
  ...
  <div class="mb-6">
    ...
    <input type="text" name="surname" id="surname" value="{{$student->surname}}"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your student surname">
  </div>
  <div class="mb-6">
    ...
    <div class="relative max-w-sm">
        ...
        <input datepicker  datepicker-autohide datepicker-format="yyyy/mm/dd" value="{{$student->birth_date}}"  type="text" name="birth_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
      </div>
  <div class="mb-6">
